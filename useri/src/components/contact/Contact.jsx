...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch(`https://formspree.io/f/mwkjrkbw`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(contact),
    })
      .then(() => {
        console.log("success from spree");
  ...
  const {
    ...
    isPending,
    data: ContactHome,
  } = useFetch("http://localhost:8000/ContactHome");
